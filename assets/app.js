...
function generate() {
  ...
  mail += `\n`;
  mail += `※工事価格も上昇傾向ですので、お見積金額の有効期限は、\n「本日より7日間」とさせていただきます。\n\nどうぞよろしくお願いいたします。\n\n【他社見積もり 徹底対抗キャンペーン 実施中！】\nただいま正直屋では、地域最安値に挑戦しております。\nもし、以下のご案内価格よりもお安い他社様のお見積もりがございましたら、ぜひお知らせください。\n\nお客様のご期待に添えるよう、可能な限り価格調整に努めさせていただきます。\n\n■写真送付ご協力のお願い（割引特典あり）\n追加部品の有無など、正確なご案内と割引価格適応のため、\nお手数ですが、現在の給湯器本体の写真を\nお送りいただきますようお願いいたします。\n\n▼写真送信フォーム\nhttps://sgfm.jp/f/standardoutdoor\n○写真を【明日24時まで】に送付で 5,000円引き！\n\n○工事後アンケートご回答でさらに 5,000円引き！\n→最大10,000円の割引を、すでに上記価格に適応しております。\nご協力いただけない場合は、あらかじめお申し出ください。\n\n■安心の長期保証\n弊社では、保証会社と提携した10年間の製品保証を標準でお付けしております。\n販売会社独自の保証とは異なり、万一の際も保証が失効することはありません。\nさらにご希望があれば、+10000円にて最長12年間の延長保証も承ります。\n\n▼詳細はこちら\nhttps://www.jpwsp.com/service/repair/\n\n【よくある質問】\n○お支払いは？ → 工事完了後の「後払い」に対応しております。\n○工事日程は？ → 下記お申し込みフォームよりご希望を登録後、\n　　　　　　　　　最短日程をご案内いたします。\n\n▼お申し込みはこちら\nhttps://1lejend.com/stepmail/kd.php?no=aegiEvXz\n\nご不明点やご相談などございましたら、\nいつでもお気軽にご連絡くださいませ。\nご要望に対しまして、スタッフ一同しっかりと努めてまいります。\n\n今後ともどうぞよろしくお願い申し上げます。\n------------------------------------\n\n【ガス工事の正直屋】\n◆正直屋 本店\n担当　${staff}\n\n愛知県名古屋市千種区内山三丁目31-20 \n今池NMビル4階\nTEL：050-5497-0700（総合コールセンター）\n------------------------------------\n◆正直屋　大阪支店\n\n大阪府堺市堺区旭ヶ丘中町2丁目2-18\n------------------------------------\n◆正直屋 横浜本店\n\n神奈川県横浜市港北区新横浜1-12-1\nソレイユルヴァン2階`;
